...
function(e) {
	...
	r.prototype.cache = n, r.prototype.define = function(e, t) {
		...
		function s() {
//			"undefined" != typeof layui[d] && "function" == typeof layui[d].init && layui[d].init(),
	...
	u.prototype.type = function() {
		...
		var n = a.pages > t ? Math.ceil((a.curr + (t > 1 ? 1 : 0)) / (t > 0 ? t : 1)) : 1,
			i = {
				...
				skip: function() {
					return ['<span class="layui-laypage-skip">&#x5230;&#x7B2C;', '<input type="text" min="1" value="' + a.curr + '" class="layui-input">', '&#x9875;<button type="button" class="layui-laypage-btn">\u8df3\u8f6c</button>', "</span>"].join("");//\u8df3\u8f6c跳转   &#x786e;&#x5b9a;确定
				}()
			};
...
function(e, t) {
	...
	l.anim = ["layer-anim-00", "layer-anim-01", "layer-anim-02", "layer-anim-03", "layer-anim-04", "layer-anim-05", "layer-anim-06"], s.pt.config = {
		...
		var n = this,
			...
			u = r.title ? '<div class="layui-layer-title" style="' + (f ? r.title[1] : "") + '"><span class="layer_line_span"></span>' + (f ? r.title[0] : r.title) + "</div>" : "";
...
layui.define(["laytpl", "laypage", "layer", "form", "util"], function(e) {
	...
	F.prototype.config = {
				...
				return !r && c.sortKey ? c.sort(c.sortKey.field, c.sortKey.sort, !0) : (layui.each(y, function(a, l) {
					...
					0 !== l.length && (r || (l[d.config.indexName] = a), c.eachCols(function(n, r) {
						...
						if (void 0 !== m && null !== m || (m = ""), !r.colGroup) {
							...
							function() {
								var e = [];
								return r.edit && e.push('data-edit="' + r.edit + '"'), r.align && e.push('align="' + r.align + '"'), r.templet && e.push('data-content="' + i("{{=d.t }}").render({ t: m }) + '"'), r.toolbar && e.push('data-off="true"'), r.event && e.push('lay-event="' + r.event + '"'), r.style && e.push('style="' + r.style + '"'), r.minWidth && e.push('data-minwidth="' + r.minWidth + '"'), e.join(" ")
							}() + ' class="' +
							function() {
								var e = [];
				...
				var r = o.field || e,
					d = function() {
						var e = o.totalRowText || "",
							...
							a = {};
						return a[r] = i,a['DATA_FIELD'] = o.field, i = u(o, i, a), t ? t[o.field] || e : o.totalRow ? i || e : e
					}(),
		...
		return layui.each(l, function(e, l) {
			return l.constructor === Array ? void i++ : void(l[d.config.checkName] && (t++, a.push(function(){
				var checked_data = d.clearCacheKey(l);
				return checked_data['data_index'] = e, checked_data;
			}())))
		}), {
			data: a,
